...
const LegalContentPage: React.FC<LegalContentPageProps> = ({title, lastUpdated, content, insets}) => {
  ...
  return (
    <View style={styles.container}>
      <ScrollView
        ...
        <View style={styles.contentContainer}>{content.map(renderContent)}</View>
      </ScrollView>
    </View>
  );
};
