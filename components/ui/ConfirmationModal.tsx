...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return (
    <Modal animationType="fade" transparent={true} visible={isVisible} onRequestClose={isLoading ? () => {} : onClose}>
        ...
        <View style={styles.modalContainer}>
          ...
          {requireConfirmationText && (
            <View style={styles.confirmationInputContainer}>
              <TextInput
                style={[styles.confirmationInput, isConfirmationTextMatched && styles.confirmationInputMatched]}
          ...
          <View style={styles.buttonRow}>
            ...
            <TouchableOpacity
              style={[
                ...
                (!isConfirmationTextMatched || isLoading) && styles.buttonDisabled,
              ]}
              onPress={onConfirm}
