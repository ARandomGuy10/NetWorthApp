...
export default function AddBalanceScreen() {
  ...
  const mutationOptions = {
    sentry: {
      location: 'add_edit_balance',
      component: 'AddBalanceScreen',
    },
  };
  const addBalanceMutation = useAddBalance(mutationOptions);
  const updateBalanceMutation = useUpdateBalance(mutationOptions);
  ...
  const handleSave = () => {
    ...
    if (isEditMode) {
      ...
      addBalanceMutation.mutate(balancePayload, {
        onSuccess: () => router.back(),
      });
    }
  };
          ...
          <Animated.View
              ...
              <View style={styles.inputGroup}>
                ...
                <CustomPicker
                  ...
                  placeholder={
                    !accountId
                      ? 'Select an account'
                      : accounts?.find(a => a.id === accountId)?.name || 'Select an account'
                  }
            ...
            <View style={styles.inputGroup}>
              ...
              <DatePicker
                ...
                disabled={loading}
              />
              <Text style={styles.helperText}>Only one balance entry per date is allowed.</Text>
            </View>
